...
Now for a more realistic example, we are doing a medical experiment with a population of people but we can only make measurements on a sample of 20 individuals. This is a first set of experiment where you give a medicine to people and check if they are alive or not by measuring their heart rate
