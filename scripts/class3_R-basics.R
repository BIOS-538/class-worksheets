...
# NOtes: Add some practice for 23/1 class as well?
...
# This is reformatted and covered in class5_demo/practice...R
...
# print the number of digits in each number of the vector
# too complex? / put in assignment
